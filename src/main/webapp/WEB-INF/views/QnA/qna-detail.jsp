					...
					<table class="table" style="TABLE-layout: fixed">
						...
						<thead class="board-thead">
							...
							<tr>
								...
								<th scope="col" class="ellipsis board-d-title">${notice1.boardsubject}</th>
								<th scope="col" class="board-d-date">${notice1.boarddate}</th>

							</tr>

							<tr>

								<th scope="col" class="board-d-writer">${notice1.userid}</th>
								<th scope="col" class="board-d-lookup">${notice1.boardreadcount}</th>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="2" scope="col" class="">
									...
									<div class="col-xs-12 col-md-12 board-d-content-box">
										...
										<p class="board-d-content">${notice1.boardcontent}</p>
							...
							<tr>
								...
								<td colspan="2" scope="col" class="">
									<div class="">
										<c:if test="${notice1.userid == user || user == 'admin'}"> 
										<a class="btn btn-default"
										href="QnAEdit.dvn?boardseq=${notice1.boardseq}" role="button">수정</a>
									    </c:if>
										<!-- delete modal -->	
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<a class="btn btn-danger"
															href="${pageContext.request.contextPath}/QnaDel.dvn?boardseq=${notice1.boardseq}"
															role="button">삭제</a>
														<button type="button" class="btn btn-default"
							...
							<tr>
								...
								<td scope="col" class="">
									...
									<c:if test="${n.userid eq userid || userid eq 'admin'}">
								...
								<form action="${pageContext.request.contextPath}/QnA/replyWrite.dvn" method="POST">
									...
									<td scope="col" class="">
										...
										<div class="form-group">
											...
											<input type="hidden" class="form-control" name="boardseq" value="${notice1.boardseq}" >
										</div>
